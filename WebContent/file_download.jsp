...
//          
    ...
    while(res.next())
          ...
          FileOutputStream fos11 = new FileOutputStream("E://enc_"+file_name);
      ...
      fos11.close();
        ...
        System.out.println("dfhfgb");
             ...
             ///////////////////decrypt file
              FileReader f = new FileReader("E://enc_"+file_name);
                            ...
                            String dec_file = "E://dec_"+file_name;
                        ...
                        String decfile = "E://dec_"+file_name;
