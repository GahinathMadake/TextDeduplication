...
%>
	<div class="main">
		...
		<div class="header">
			<div class="logo">
				<h1>
					<a href="homepage.jsp"><span>Text Deduplication</span><small>Simple
			...
			<div class="mainbar">
				<div class="article">
					...
					<form class="form1" action="UploadServlet" method="post"
						...
						<input type="hidden" name="user" value="<%=user_id%>" /> <input
							type="text" name="privilege" value=" " /> Browse File: :
						<div>
							<input type="file" value="" name="path" size="30"
								maxlength="2048" />
						</div>
						<br /> <br />
						<div>
