...
%>
		...
		<div class="mainbar">
			<div class="article">
				<h4 align="right">
					...
					<%=user_id%></h4>
				<br />
				<form class="form1" action="Insert_Data_1.jsp" method="post">

					<%
          String did = request.getParameter("gat1");
    ...
    String sql = "select * from k_p where id = "+did+"";
    System.out.println("sql :"+sql);
         ...
         AESFile ae = new AESFile();
                            ...
                            ae.generateKey(db_enc_data, "AES");
                             String sf = "select * from n_file where u_id = "+id+"";
