	...
	<div class="content">
		<div class="mainbar">
			<div class="article">
				...
				<form class="form1" action="Modify_Data_1.jsp" method="post">



					<%
						String uid = request.getParameter("gat1");
							...
							ResultSet rss = stt
									.executeQuery("select * from n_file where u_id = " + id
											+ " ");
							String fileco = null;
							while (rss.next()) {
					...
					%>
					<textarea name="data"><%=decryptedText%></textarea>
