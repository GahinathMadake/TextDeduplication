           ...
           Class.forName(driver);
               ...
               st=(Statement) connection.createStatement(); 
                System.out.println(" run 1");
                 String sql2="select * from graph_m";
                 ...
                 while(res.next())
                   ...
                   System.out.println(" run");
                     ...
                     a[flag]=res.getString("time_r");
                     System.out.println("hva1l"+flag+":"+a[flag]);
...
%>
        ...
        var data = google.visualization.arrayToDataTable([
          ['Incoherency Bound', ' Uploading Time ', ' Encryption Time ', 'Key Generation Time'],
          [' Time ',  <%=a[0]%>,      <%=a[1]%>, <%=a[2]%> ],
