...
class MyClass {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String hash = FileUtil.getChecksum(path, "MD5",privilege,sb); //or "SHA-256", "SHA-384", "SHA-512"  
             String hash1 = FileUtil.getChecksum(path1, "MD5",privilege,sb); //or "SHA-256", "SHA-384", "SHA-512"  
