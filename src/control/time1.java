 ...
 */
public class time1 extends ApplicationFrame {
...
public static String s11; public static String s12;public static String s13;public static double d,d1,d2;
     ...
     */
    public time1(String title) throws IOException {
    ...
    private static CategoryDataset createDataset() throws IOException {
        ...
        String category1 = "File Information";
            ...
            String s = "Select * from graph_d where id = 1";
           ...
           while(rs.next())
           {
               ...
               dd= rs.getString("down_time");
                d = Double.parseDouble(dd);
                System.out.println("fisrt");
                s1 = rs.getString("dec_time");
...
//        t.setVisible(true);
          ...
          dataset.addValue(d, "Download", category1);
          dataset.addValue(d1, "Decrypt", category1);
