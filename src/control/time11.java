...
public static String s11; public static String s12;public static String s13;public static double d,d1,d2;
    ...
    private static CategoryDataset createDataset() throws IOException {
        ...
        String category1 = "size";
                 String series2 = "Time Required to Upload File";
            String s = "Select * from n_file ";
           ...
           while(rs.next())
           {
               ...
               dd= rs.getString("size");
                d = Double.parseDouble(dd);
                sum = sum+d;
               i++;
           
           }
           Statement mmt = conn.createStatement();
           String s12 = "select * from dedup_data";
           ResultSet rs2 = mmt.executeQuery(s12);
           double sum1 = 0.0;
           
           while(rs2.next())
           {
               String ds  = rs2.getString("size");
           double dou =  Double.parseDouble(ds);   
               sum1 = sum1+dou;
           }
           
            //Statement st1 = conn.createStatement();
           double t_sum = sum+sum1;
           
          dataset.addValue(t_sum, "without Deduplication", category1);
          dataset.addValue(sum, "with Deduplication", category1);
...
//        dataset.addValue(6.0, series3, category5);
    ...
    private static JFreeChart createChart(CategoryDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createBarChart(
            "Storage Graph ",         // chart title
            "Total Size",               // domain axis label
            " ",                  // range axis label
            dataset,                  // data
